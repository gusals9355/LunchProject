...
<link rel="stylesheet" type="text/css" href="http://localhost:8090/css/main.css">
<title>abcd</title>
<style>
.map_wrap, .map_wrap * {margin:0;padding:0;font-family:'Malgun Gothic',dotum,'돋움',sans-serif;font-size:12px;}
.map_wrap a, .map_wrap a:hover, .map_wrap a:active{color:#000;text-decoration: none;}
.map_wrap {position:relative;width:100%;height:500px;}
#menu_wrap {twidth:250px;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
...
<div class="map_wrap">
	...
	<!-- <script type="text/javascript" src="http://localhost:8090/js/jquery.min.js"></script>
	<script type="text/javascript" src="http://localhost:8090/js/jquery1.min.js"></script>
	<script type="text/javascript" src="http://localhost:8090/js/popper.min.js"></script>
	<script type="text/javascript" src="http://localhost:8090/js/boot/bootstrap.js"></script> -->
